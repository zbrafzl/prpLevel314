...
{
    [QaBasicAuthentication]
    public class PrpQaBasedController : ApiController
    {
    }

    public class QaBasicAuthenticationAttribute : AuthorizationFilterAttribute
    {
        ...
        public static bool IsAuthorizedUser(string Username, string Password)
        {
            ...
            if (Username == "prp.bop.qa" && Password == "bop@123#prp")
            {
                isValidUser = true;
            }
