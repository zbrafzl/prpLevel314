...
{
    [DataQaAuthentication]
    public class PrpDataQaBaseController : ApiController
    {
    }


    public class DataQaAuthenticationAttribute : AuthorizationFilterAttribute
    {
        ...
        public static bool IsAuthorizedUser(string Username, string Password)
        {
            ...
            if (Username == "prp.data.qa" && Password == "data@123#prp")
            {
                isValidUser = true;
            }
